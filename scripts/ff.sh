...
python3 frame_finder/frame_finder.py roberta-base data/open_sesame_v1_data/fn1.7

nohup python3 frame_finder/frame_finder.py roberta-base data/open_sesame_v1_data/fn1.7 &